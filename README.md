...
4. **Object Clump (物体物理簇 Demo)**：
   - TypeScript 重写与 `@react-three/rapier` 物理整合，实现 40 个亮面球体在引力驱动下向中心靠拢的动态聚簇效果。
...
- [lusion-connectors.png](file:///d:/01_AIGC/03_Antigravity/BALLPIT%20TOTAL/public/thumbnails/lusion-connectors.png)
  - Lusion Connectors 卡片的真实 3D 渲染截图缩略图。
- [ssgi-spheres.png](file:///d:/01_AIGC/03_Antigravity/BALLPIT%20TOTAL/public/thumbnails/ssgi-spheres.png)
  - SSGI Spheres 卡片的真实 3D 渲染截图缩略图。
- [object-clump.png](file:///d:/01_AIGC/03_Antigravity/BALLPIT%20TOTAL/public/thumbnails/object-clump.png)
  - Object Clump 卡片的真实 3D 渲染截图缩略图。
