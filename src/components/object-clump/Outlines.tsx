  ...
  React.useLayoutEffect(() => {
    ...
    if (parent && parent.geometry) {
      ...
      if (parent.skeleton) {
        ...
        skinnedMesh.bind(parent.skeleton, parent.bindMatrix)
        mesh = skinnedMesh
        group.add(mesh)
      } else if (parent.isInstancedMesh) {
        const instancedMesh = new THREE.InstancedMesh(parent.geometry, material, parent.count)
        instancedMesh.instanceMatrix = parent.instanceMatrix
        mesh = instancedMesh
        group.add(mesh)
      } else {
        mesh = new THREE.Mesh()
